...
async function selectQuery(selectQuery) {
  ...
  const query1Results = await client.query(query1);
...
async function query1() {
  ...
  logResults(await selectQuery(query));
  console.log("\n....................................................\n");
}

async function query2() {
  // 2. What are the names of countries that have "land" in their names?
  const query = "SELECT Name FROM country WHERE Name ILIKE '%land%'";
...
async function query4() {
  ...
  const query = "SELECT Name FROM country WHERE Continent LIKE 'Europe%'";
...
async function query7() {
  ...
  const query = "SELECT Population FROM city WHERE name like '%Rotterdam%'";
...
async function query10() {
  ...
  const query = "SELECT SUM(Population) FROM country";
